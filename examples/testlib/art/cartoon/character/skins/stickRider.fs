...
(geometry, palette) =>
{
  rideBetween: if rideParam == null then [] else if rideParam.between == null then rideParam else rideParam.between;
  rideFront: if rideParam == null then [] else if rideParam.front == null then [] else rideParam.front;
  rideBack: if rideParam == null then [] else if rideParam.back == null then [] else rideParam.back;
  ...
  // Insert the ride geometry between the two legs (back leg first, then ride, then front leg).
  eval backHands
    + backLegs
    + rideBack
    + rideBetween
